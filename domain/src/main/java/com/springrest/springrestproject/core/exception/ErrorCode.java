...
public enum ErrorCode {
    ...
    SCRIPT_EXECUTION_DISABLED(HttpStatus.FORBIDDEN, "error.script_execution_disabled"),
    SCRIPT_HOOK_EXECUTION_FAILED(HttpStatus.BAD_REQUEST, "error.script_hook_execution_failed"),
    SCRIPT_CACHE_FAILED(HttpStatus.BAD_GATEWAY, "error.script_cache_failed"),
    SCRIPT_INVALID_ASSOCIATION(HttpStatus.BAD_REQUEST, "error.script_invalid_association"),
    SCRIPT_ALREADY_EXISTS_FOR_TARGET(HttpStatus.CONFLICT, "error.script_already_exists_for_target"),
